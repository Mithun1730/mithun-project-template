          ...
          <div class="card-body">
            ...
            <form action="Login_script.php" method="POST">
              <div class="mb-3">
                ...
                <input type="text" name="username" id="name" class="form-control" placeholder="" autocomplete="off" required="">
              </div>
              <div class="mb-3">
                <label class="form-label"><b>Password</b></label>
                <input type="text" name="password" id="pass" class="form-control" placeholder="" autocomplete="off" required="">
              </div>
